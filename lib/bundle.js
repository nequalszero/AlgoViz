...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuickSort = function (_AnimationOptions) {
	  ...
	  function QuickSort(options) {
	    ...
	    _this.startElClassName = "start-element";
	  ...
	  _createClass(QuickSort, [{
	    ...
	    value: function generateIdToColorArray() {
	      return [["layer0", this.colors.lightGreen2], ["layer1", this.colors.lightGreen], ["layer2", this.colors.lightBlue2], ["layer3", this.colors.lightBlue], ["layer4", this.colors.lightBlue3], ["layer5", this.colors.lightBlue3], ["layer6", this.colors.lightBlue], ["layer7", this.colors.lightBlue2], ["layer8", this.colors.lightGreen]];
	    }
	  }, {
	    ...
	    value: function renderStartLayer() {
	      ...
	      this.startElements.forEach(function (el, idx) {
	        elementOptions = {
	          ...
	          className: _this2.startElClassName
	        };
	    ...
	    value: function renderLayer1() {
	      ...
	      window.setTimeout(function () {
	        ...
	        var layerHeight = _this3.layerHeight * 2;
	        var $div = $("<div>", { id: "layer1", "class": "layer",
	          height: layerHeight });
	        var $svgContainer = $("<svg>", { width: $('#' + _this3.visAreaId).width(),
	          height: layerHeight,
	          class: "light-blue" });
	        var $dummySvg = $("<svg>", { width: $('#' + _this3.visAreaId).width(),
	          height: _this3.layerHeight,
	          y: _this3.layerHeight,
	          class: "light-blue" });
	        $svgContainer.append($dummySvg);
	        $div.append($svgContainer);
	        $('#' + _this3.visAreaId).append($div);
	        $("body").html($("body").html());
	      }, 2000);
	    }
	  }, {
