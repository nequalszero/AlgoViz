	  ...
	  _createClass(Quicksort, [{
	    ...
	    value: function renderBackgrounds() {
	      ...
	      this.backgroundClasses = {
	        0: this.colorClasses["lightGreen2"],
	        1: this.colorClasses["lightGreen"],
	        2: this.colorClasses["lightBlue"],
	        3: this.colorClasses["lightBlue2"],
	        4: this.colorClasses["lightBlue3"],
	        5: this.colorClasses["lightBlue3"],
	        6: this.colorClasses["lightBlue2"],
	        7: this.colorClasses["lightBlue"],
	        8: this.colorClasses["lightGreen"]
	      };
	
	      Object.keys(this.backgroundClasses).forEach(function (layer) {
	        _this6.drawingArea.append(_this6.createBackgroundLayerElement({
	          layer: layer,
	          colorClass: _this6.backgroundClasses[layer]
	        }));
	      });
	    }
	    ...
	    value: function animateLayers() {
	      ...
	      this.layers.forEach(function (layer, idx) {
	        var referenceEl = _this8.referenceEls[layer];
	        var fromArray = _this8.fromArrays[layer];
	
	        _this8.createAnimation({
	          fromLayer: _this8.fromLayers[layer],
	          toLayer: _this8.toLayers[layer],
	          val: referenceEl
	        });
	    ...
	    value: function renderSection(options) {
	      ...
	      sectionChars.forEach(function (char) {
	        if (char === '[' || char === ']') {
	          _this9.drawingArea.append(_this9.createArrayBracket({
	            topOffset: topOffset,
	          ...
	          _this9.drawingArea.append(_this9.createPlusSign({
	            topOffset: topOffset,
	            leftOffset: layerLeftOffset,
	            layer: options.toLayer
	          }));
	          ...
	          _this9.drawingArea.append(_this9.createSpaceEl({
	            topOffset: topOffset,
	            leftOffset: layerLeftOffset,
	            layer: options.toLayer
	          }));
	          ...
	          var newEl = _this9.createArrayElement({
	            layer: options.toLayer,
	            val: parseInt(char),
	            topOffset: topOffset,
	            leftOffset: layerLeftOffset,
	          ...
	          _this9.drawingArea.append(newEl);
	    ...
	    value: function createPaths(options) {
	      ...
	      options.fromArray.forEach(function (el) {
	        prevElements[el] = $('#' + _this10.createArrayElId(options.fromLayer, el));
	      });
	      ...
	      sectionChars.forEach(function (char) {
	        if (char === '[' || char === ']') {
	          layerLeftOffset += _this10.bracketWidth;
	        } else if (char === '+') {
	          layerLeftOffset += _this10.plusWidth;
	        } else if (char === ' ') {
	          layerLeftOffset += _this10.spaceWidth;
	        } else {
	          // must be an array element at this point
	          ...
	          layerLeftOffset += _this10.elementWidth;
	        }
	      });
	    }
	  }]);
