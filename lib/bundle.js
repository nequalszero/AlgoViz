	  ...
	  _createClass(QuickSort, [{
	    ...
	    value: function renderStartElements() {
	      ...
	      this.startElements.forEach(function (el, idx) {
	        elementOptions = {
	          val: el,
	          svgHeight: _this2.elementHeight,
	          svgWidth: _this2.elementWidth,
	          svgXPos: _this2.leftIndent + idx * _this2.elementWidth,
	          svgYPos: 0,
	          svgElXPosOffset: 0,
	          svgElYPosOffset: 0,
	          fillColor: "white",
	    ...
	    value: function renderLayer1() {
	      ...
	      window.setTimeout(function () {
	        ...
	        var $svgContainer = $('#' + _this3.svgContainerId);
	        ...
	        var options = {
	          ...
	          oldLayerNum: 0,
	          newLayerNum: 1,
	          fillColor: '' + _this3.pivotColor
	        };
	
	        _this3.moveArrayElement(options);
	        $("body").html($("body").html());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnimationOptions = function () {
	  ...
	  _createClass(AnimationOptions, [{
	    ...
	    key: "pathElIdName",
	    value: function pathElIdName(oldLayerNum, newLayerNum, val) {
	      return "path-" + oldLayerNum + "-" + newLayerNum + "-val-" + val;
	    }
	  }, {
	    ...
	    value: function moveArrayElement(options) {
	      ...
	      var svgXPos = void 0,
	          ...
	          svgHeight = void 0,
	          svgWidth = void 0;
	      var svgElXPosOffset = void 0,
	          svgElYPosOffset = void 0;
	      ...
	      var pathIdName = this.pathElIdName(options.oldLayerNum, options.newLayerNum, val);
	      ...
	      var $svgContainer = $("#" + this.svgContainerId);
	      var newSvgEl = this.createSvgArrayElement(svgArrayElementParams);
	      var newPath = this.createPath(pathParams);
	      newSvgEl.append(newPath);
	      $svgContainer.append(newSvgEl);
	      $("body").html($("body").html());
	
	      var myPath = _animejs2.default.path("#" + pathIdName);
	    ...
	    key: "createPath",
	    value: function createPath(options) {
	      var xStart = this.elementCx + options.svgElXPosOffset;
	      var yStart = this.elementCy + options.svgElYPosOffset;
	    ...
	    value: function createSvgArrayElement(options) {
	      ...
	      var textParams = { x: this.textX + options.svgElXPosOffset,
