	  ...
	  _createClass(Quicksort, [{
	    ...
	    value: function renderSortingLayers() {
	      ...
	      this.layers.forEach(function (layer, idx) {
	        ...
	        var renderOptions = {
	          fromArray: _this3.fromArrays[layer],
	          fromLayer: _this3.fromLayers[layer],
	          toLayer: _this3.toLayers[layer],
	          sectionCharString: _this3.sectionCharStrings[layer],
	          referenceEl: _this3.referenceEls[layer],
	          topOffset: _this3.toLayers[layer] * _this3.elementHeight,
	          layerLeftOffset: _this3.computeLayerLeftOffset(_this3.sectionCharStrings[layer], _this3.referenceEls[layer], _this3.customOffset[layer])
	        };
	        ...
	        if (idx <= 12) _this3.createPaths(renderOptions);
	      });
	    }
	  }, {
	    key: 'animateLayers',
	    value: function animateLayers() {
	      ...
	      this.layers.forEach(function (layer, idx) {
	        if (idx <= 12) {
	          (function () {
	            var referenceEl = _this4.referenceEls[layer];
	            var fromArray = _this4.fromArrays[layer];
	
	            _this4.createAnimation({
	              fromLayer: _this4.fromLayers[layer],
	              toLayer: _this4.toLayers[layer],
	              val: referenceEl
	            });
