	  ...
	  _createClass(AlgorithmVisualization, [{
	    ...
	    value: function buildOptions() {
	      return {
	        ...
	        fontSizeFactor: 0.5,
	        animationSpeed: 6, // pixels per milli-second
	...
	var Quicksort = function (_AnimationOptions) {
	  ...
	  _createClass(Quicksort, [{
	    ...
	    value: function configureTimingOptions() {
	      ...
	      this.timeStagger = 200;
	      this.timingBetweenLayers = 600;
	      this.fadeInSpeed = 1500;
	      this.startAnimationRunTime = this.timingBetweenLayers + (this.startArray.length - 1) * this.timeStagger + this.fadeInSpeed;
	
	      console.log(this.startAnimationRunTime);
	      ...
	      this.layers.forEach(function (layer) {
	        ...
	        if (layer !== _this2.layers[0]) {
	          ...
	          _this2.layerDelays[layer].base += _this2.layerDelays[prevLayer].base;
	        }
	
	        if (_this2.toLayers[prevLayer] !== toLayer) {
	          _this2.layerDelays[layer].base += _this2.timingBetweenLayers;
	          if (prevLayer === _this2.layers[0]) {
	            console.log("prevLayer: ", prevLayer);
	            _this2.layerDelays[prevLayer].base = _this2.startAnimationRunTime;
	          }
	        }
	        ...
	        if (toLayer <= 4) {
	          ...
	          _this2.layerDelays[layer].elements[referenceEl] = referenceElPathTime + _this2.layerDelays[layer].waitTime;
	          _this2.layerDelays[layer].base += referenceElPathTime + _this2.timeStagger;
	        ...
	        _this2.fromArrays[layer].forEach(function (el) {
	          ...
	          _this2.layerDelays[layer].elements[el] = pathTime + _this2.layerDelays[layer].waitTime;
	          _this2.layerDelays[layer].base += pathTime + _this2.timeStagger;
	    ...
	    value: function testAnimation() {
	      ...
	      setTimeout(function () {
	        ...
	        console.log(_this3.layerDelays[prevLayer].base);
	      ...
	      this.layers.forEach(function (layer) {
	        setTimeout(function () {
	          ...
	          if (prevToLayer !== toLayer) {
	            console.log("toLayer: ", toLayer);
	            console.log(_this3.layerDelays[layer].base);
	            layerClass = _this3.getLayerClass(toLayer);
	          ...
	          if (toLayer <= 4) {
	            console.log("\ntoLayer: ", toLayer);
	            console.log("referenceEl: ", referenceEl);
	            console.log("delayTime: ", _this3.layerDelays[layer].elements[referenceEl]);
	            ...
	            }.bind(_this3), _this3.layerDelays[layer].elements[referenceEl]);
	          }
	          ...
	          var _loop = function _loop(i) {
	            ...
	            }.bind(_this3), _this3.layerDelays[layer].elements[el]);
	          };
	    ...
	    value: function fadeInStartLayer() {
	      ...
	      setTimeout(function () {
	        totalTime += _this4.timeDelay;
	        // console.log(`totalTime update: ${totalTime}`);
	        _this4.startArray.forEach(function (el, idx) {
	          setTimeout(function () {
	            if (idx > 0) totalTime += _this4.timeStagger;
	            if (idx === _this4.startArray.length - 1) totalTime += _this4.fadeInSpeed;
	            // console.log(`totalTime update: ${totalTime}`);
	    ...
	    value: function renderLayers() {
	      ...
	      this.layers.forEach(function (layer, idx) {
	        ...
	        var renderOptions = {
	          fromArray: _this6.fromArrays[layer],
	          fromLayer: _this6.fromLayers[layer],
	          toLayer: _this6.toLayers[layer],
	          sectionCharString: _this6.sectionCharStrings[layer],
	          referenceEl: _this6.referenceEls[layer],
	          topOffset: _this6.toLayers[layer] * _this6.elementHeight,
	          layerLeftOffset: _this6.computeLayerLeftOffset(_this6.sectionCharStrings[layer], _this6.referenceEls[layer], _this6.customOffset[layer])
	        };
	        // if (layer === 'L6-right-r') debugger
	        _this6.renderSection(renderOptions);
	        renderOptions.animate = true;
	        _this6.renderSection(renderOptions);
	
	        _this6.createPaths(renderOptions);
	      });
	    }
	    ...
	    value: function animateLayers() {
	      ...
	      this.layers.forEach(function (layer, idx) {
	        var referenceEl = _this7.referenceEls[layer];
	        var fromArray = _this7.fromArrays[layer];
